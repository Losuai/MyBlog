<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.myBlog.models.User"%>
...
<header class="header-navigation" id="header">
  ...
  <div class="logo"><a href="index.jsp">游客</a></div>
  <div class="logo"><a href="signup.html"><font size="2">&nbsp;&nbsp;&nbsp;注册</font></a></div>
  <div class="logo"><a href="login.html"><font size="2">&nbsp;&nbsp;&nbsp;登录</font></a></div>
  </c:when>
  <c:otherwise>
  <div class="logo"><a href="index.jsp"><c:out value="${sessionScope.user.username }" />的博客</a></div>
  <div class="logo"><a href="index.jsp"><font size="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注销</font><c:remove var="user" scope="session" /></a></div>
  </c:otherwise>
  </c:choose>
